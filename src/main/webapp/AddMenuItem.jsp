...
<meta charset="utf-8" />
<title>Add Menu Item | OrderOrbit</title>
	...
	<div id="layout-wrapper">
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<c:choose>
					<c:when test="${message.startsWith('Item added successfully')}">
						<span style="color: green; font-size: 18px;"><c:out
								value="${message}" /></span>
					</c:when>
					<c:otherwise>
						<span style="color: red; font-size: 14px;"><c:out
								value="${message}" /></span>
					</c:otherwise>
				</c:choose>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title mb-4">Add Menu Item</h4>
								<form method="post" action="AddMenuItemServlet"
									...
									<div class="mb-3 row">
										...
										<div class="col-md-10">
											<input class="form-control" type="number" name="item_price"
												id="item_price" step=".01" required>
										</div>
									</div>
									<div class="mb-3 row">
									...
									<div class="mb-3 row">
										<label for="example-number-input"
											class="col-md-2 col-form-label">Item Image</label>
										<div class="col-md-10">
