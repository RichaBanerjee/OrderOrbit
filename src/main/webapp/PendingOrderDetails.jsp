...
<meta charset="utf-8" />
<title>Pending Order Details | OrderOrbit</title>
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title mb-4">Pending Orders</h4>
								<div class="table-responsive">
									<table class="table align-middle table-nowrap mb-0">
										...
										<tbody>
								<%
												List<Orders> orderList = (List<Orders>) session.getAttribute("pending_orders");
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        document.querySelectorAll('.clickable-row').forEach(row => {
            row.addEventListener('click', function() {
                ...
                window.location.href = '/orderorbit/EmployeeOrderDetails.jsp?order_Id=' + orderId;
            });
        });
    });
</script>
