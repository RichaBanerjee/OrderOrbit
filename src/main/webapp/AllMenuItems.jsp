...
<meta charset="utf-8" />
<title>Menu Details | OrderOrbit</title>
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title mb-4">All Menu Items</h4>
									...
									<table class="table align-middle table-nowrap mb-0">
										<thead class="table-light">
											<tr>
												...
												<th class="align-middle">Availibility</th>
										...
										<tbody>
											<tr>
												<%
													List<MenuItem> itemList = (List<MenuItem>) session.getAttribute("all_items");
