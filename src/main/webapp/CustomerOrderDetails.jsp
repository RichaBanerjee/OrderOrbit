...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.orderorbit.model.OrderDetails"%>
<%@ page import="com.orderorbit.dao.OrderDetailsDao"%>
...
<head>
    <meta charset="utf-8">
    <title>Order Orbit Order Details</title>
...
<%
      ...
      <div class="container-xxl position-relative p-0">
				...
				<div class="collapse navbar-collapse" id="navbarCollapse" style="font-family: 'Heebo','sans-serif';">
					<div class="navbar-nav ms-auto py-0 pe-4">
						...
						<a class="nav-item nav-link" href="Cart.jsp"><span
							...
							<a href="ViewPastOrder" class="nav-item nav-link active">Orders</a>
							<a class="nav-link"
			...
			<div class="container-xxl py-5 bg-dark hero-header mb-5">
				<div class="container text-center my-5 pt-5 pb-4">
					<h1 class="display-3 text-white mb-3 animated slideInDown">Order Item Details</h1>
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb justify-content-center text-uppercase">
							<li class="breadcrumb-item"><a href="Home.jsp">Home</a></li>
							<li class="breadcrumb-item text-white active" aria-current="page"><a href="ViewPastOrder.jsp">Orders</a></li>
						</ol>
					</nav>
				</div>
			</div>
 ...
 <div class="container main">
        <h1 class="mb-4">Your Order Details</h1>
        <a href="ViewPastOrder.jsp" class="btn btn-primary btn-back"><i class="fas fa-arrow-left mr-1"></i> Back to Orders</a>
        <div class="table-responsive">
            <table class="table table-hover table-bordered">
                ...
                <tbody>
						...
						DbConnection dConnection = DbConnection.getDbConnnection();
						OrderDetailsDao orderDetailsDao = new OrderDetailsDao(dConnection);
						List<OrderDetails> orderDetailsList = orderDetailsDao.getAllDetailsById(orderId);
						...
						<tr>
							<td><%=order.getOrderId().getOrderId()%></td>
							<td><%=order.getItemId().getItemName()%></td>
