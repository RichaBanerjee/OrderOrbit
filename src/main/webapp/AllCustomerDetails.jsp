<%@page import="com.orderorbit.model.Customer"%>
...
<meta charset="utf-8" />
<title>Customer Details | OrderOrbit</title>
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title mb-4">All Customers</h4>
								<div class="table-responsive">
									<table class="table align-middle table-nowrap mb-0">
										...
										<tbody>
											<tr>
												<%
													List<Customer> customerList = (List<Customer>) request.getAttribute("all_customers");
