...
<meta charset="utf-8" />
<title>Order Details | OrderOrbit</title>
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title mb-4">Orders Details</h4>
										...
										<tbody>
											<!-- <c:forEach items="${orderList}" var="order">
                                                    <tr>
                                                        ...
                                                        <td>${order.is_picked}</td>
                                                         <td>
                                                            <span class="badge badge-pill badge-soft-success font-size-11">${order.order_status}</span>
                                                        </td>
