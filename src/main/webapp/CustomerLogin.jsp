		...
		<form action="CustomerLoginServlet" method="post">
			<div class="form-group">
				<input type="email" class="form-control" id="email"
					placeholder="Email" name="customerEmail" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" required >
			</div>
			<div class="form-group">
				<input type="password" class="form-control" id="password"
					placeholder="Password" name="customerPassword" autocomplete="new-password" required>
			</div>
			<button type="submit" class="btn btn-yellow btn-block">Login</button>
			<p class="text-center mt-3 small-text">
				 <a href="ForgotPassword.jsp"
					style="color: #FFC107;">Forgot Password?</a>
			</p>
			<p class="text-center mt-3 small-text">
