		...
		<nav
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<div class="navbar-nav ms-auto py-0 pe-4">
					...
					<a href="UserDashboard.jsp" class="nav-item nav-link">Menu</a> <a
						class="nav-item nav-link" href="Cart.jsp"><span
			...
			<div class="container my-5 py-5">
				<div class="row align-items-center g-5">
					<div class="col-lg-6 text-center text-lg-start">
						<h3 class="text-white animated slideInLeft mb-4 pb-2">
							Welcome<span style="color: #FEA116"> <%=(String) session.getAttribute("customer_name")%></span>
						</h3>
