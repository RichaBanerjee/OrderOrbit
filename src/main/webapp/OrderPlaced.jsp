	...
	<div class="container-xxl bg-white p-0">
				...
				<div class="collapse navbar-collapse" id="navbarCollapse"
					...
					<div class="navbar-nav ms-auto py-0 pe-4">
						...
						<a class="nav-item nav-link" href="Cart.jsp"><span
							...
							class='fa fa-shopping-cart'></i></a> <a href="ViewPastOrder"
							class="nav-item nav-link">Orders</a> <a class="nav-link"
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb justify-content-center text-uppercase">
							...
							<li class="breadcrumb-item text-white active" aria-current="page"><a
								href="UserDashboard.jsp">Menu</a></li>
						</ol>
					</nav>
				</div>
			</div>
		...
		<div class="container">
			...
			<div style="text-align: center; margin-bottom: 80px;">
				<img
					src="uploadImages\order_placed_image.jpeg" style="width: 70%;"></img>
			</div>

			<h5 style="text-align: center;">
				<p>Thank you for placing your order with OrderOrbit!</p>
				<p>We have received your order and are already hard at work
					preparing it with care :)</p>
				<p>Rest assured, we'll notify you as soon as your order is ready
					for pickup. You can expect an email from us with all the necessary
					details.</p>
			</h5>
			<div class="text-center"
				style="text-align: center; margin-top: 80px;">

				<a href="UserDashboard.jsp" class="btn btn-primary btn-back"><i
					class="fas fa-arrow-left mr-1"></i> Back to Menu</a> &nbsp; &nbsp;
				&nbsp; &nbsp; <a href="ViewPastOrder"
					class="btn btn-primary btn-back">View Past Orders    <i
					class="fas fa-arrow-right mr-1"></i> </a>
			</div>
		</div>
